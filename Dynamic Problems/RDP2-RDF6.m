...
%         nt;         % Number of distinct steps
    ...
    methods
        ...
        function score = CalMetric(obj,metName,Population)
            ...
            save("E:\动态偏好\Knowledge-Transfer-GMM\Code\PlatEMO-master\PlatEMO\IGD\DIPDF6"+".mat","Score_IGD");
            score = mean(Scores);
%             fileID = fopen('E:\动态偏好\Knowledge-Transfer-GMM\Code\PlatEMO-master\PlatEMO\20IGD-RDF\IGD_RDF6.txt', 'a'); % 'a' 表示以追加模式打开文件
%             fprintf(fileID, '%0.5f\n', score);
%             fclose(fileID);
        end
        %% Calculate the metric value
